...
if [ -e "/sys/bus/i2c/devices/2-004a/keypad_enable" ]; then
	...
	ln -s /sys/bus/i2c/devices/2-004a/easy_wakeup_gesture /data/tp/keypad_enable
fi
...
if [ -e "/sys/bus/i2c/devices/2-005d/keypad_enable" ]; then
	...
	ln -s /sys/bus/i2c/devices/2-005d/wakeup_gesture /data/tp/keypad_enable
fi
...
if [ -e "/sys/bus/i2c/devices/2-0024/keypad_enable" ]; then
	...
	ln -s /sys/bus/i2c/devices/2-0024/easy_wakeup_gesture /data/tp/keypad_enable
fi
